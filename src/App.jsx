...
import PlayerIdentification from '@/components/PlayerIdentification.jsx';
...
function App() {
  ...
  const handleCreateGame = (gameData) => {
    ...
    toast({
      title: "Jogo criado!",
      description: `O jogo "${gameData.title}" foi adicionado.`
    });
    setCurrentView('home');
  };
  ...
  const handleGameComplete = (result) => {
    ...
    toast({
      ...
      description: `Parabéns ${currentPlayer.name}! Você fez ${result.score} pontos.`
    });
    
    setCurrentView('home');
  };

  const handlePlayerIdentified = (playerData) => {
      ...
      <div className="container mx-auto px-4 py-6">
        <header className="bg-purple-600 text-white rounded-lg p-6 mb-8 shadow-md">
          <div className="flex items-center justify-between">
            ...
            {currentPlayer && (
              <div className="flex items-center space-x-2 bg-purple-700 rounded-md px-3 py-1">
        ...
        {currentView !== 'play' && currentView !== 'identify' && (
        ...
        <main>
            ...
            {currentView === 'identify' && (
              <PlayerIdentification 
                onPlayerIdentified={handlePlayerIdentified}
                onCancel={() => setCurrentView('home')}
              />
            )}
        </main>
